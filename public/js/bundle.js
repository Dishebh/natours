...
var stripe = Stripe('pk_test_Be5syimLELnmeSEKHk6TOFzb006Ojixp79');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log('Hi from the booking!!'); // 1) Get checkout session from API
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38211" + '/');
